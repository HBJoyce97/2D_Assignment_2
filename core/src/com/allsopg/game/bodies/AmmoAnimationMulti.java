...
public class AmmoAnimationMulti extends Sprite {
    ...
    public AmmoAnimationMulti(String atlasString_1, String atlasString_2, Texture t, Vector2 pos, Animation.PlayMode loopType){
        ...
        idle = new Animation(Constants.AMMO_FRAME_DURATION, regions_1, loopType);
        ...
        ammo = new Animation(Constants.AMMO_FRAME_DURATION, regions_2, loopType);
